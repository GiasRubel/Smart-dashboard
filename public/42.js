...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_social_signup_service__ = __webpack_require__(1135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_api__ = __webpack_require__(180);
//
//
//
//
    ...
    socialLogin: function socialLogin(url) {
        ...
        var socialInterval = setInterval(function () {
            ...
            if (localStorageDataLogin) {
                ...
                setInterval.cancel(socialInterval);
            }
        }, 2000);
    },
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_axios_service__ = __webpack_require__(199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vee_validate__ = __webpack_require__(201);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config_api__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_config__ = __webpack_require__(200);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        __WEBPACK_IMPORTED_MODULE_1_vee_validate__["a" /* Validator */].extend('emailOrPhone', {
            getMessage: function getMessage(field) {
                return 'The ' + field + ' must be either a valid e-mail or  phone number';
            },
            validate: function validate(value) {
                return __WEBPACK_IMPORTED_MODULE_3__config_config__["a" /* default */].EMAILREGEXP.test(value) || __WEBPACK_IMPORTED_MODULE_3__config_config__["a" /* default */].BDMOBILEREGEXP.test(value);
            }
        });
                ...
                if (valid) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].postData(__WEBPACK_IMPORTED_MODULE_2__config_api__["a" /* default */].login, _this.login).then(function (response) {
                        if (response.data.result && response.data.message) {
                            ...
                            if (_this.cart && Object.keys(_this.cart).length) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "login-form" }, [
              ...
              _c("input", {
                directives: [
                  ...
                  },
                  {
                    name: "validate",
                    rawName: "v-validate",
                    value: "required|emailOrPhone",
                    expression: "'required|emailOrPhone'"
                  }
                ],
                ...
                attrs: {
                  ...
                  name: "emailOrPhone",
                  id: "emailOrPhone",
                  "data-vv-as": "email or phone number"
                },
    ...
    _c(
      ...
      [
        _c("span", [_vm._v("New to ShopnShipbd?")]),
        _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c("label", { attrs: { for: "emailOrPhone" } }, [
      _vm._v("Email (phone for mobile accounts)\n                "),
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_login_LoginForm__ = __webpack_require__(1140);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_login_LoginSocialLink__ = __webpack_require__(1131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_cart_CartProductList__ = __webpack_require__(1229);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_cart_CartProductTotalCount__ = __webpack_require__(1234);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_cart_CartPaymentMethod__ = __webpack_require__(1239);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__config_api__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_cookie__ = __webpack_require__(203);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        /*if (!cookie.getCookie('session_id') && !this.authenticated && !this.authenticated.verify) {
            this.sessionCreate();
        }*/
        if (this.$route.query.session_id === __WEBPACK_IMPORTED_MODULE_6__services_cookie__["a" /* default */].getCookie('session_id')) {
    ...
    methods: {
        /*sessionCreate() {
            if(typeof this.$route.query.session_id !== "undefined") {
                cookie.setCookie('session_id', this.$route.query.session_id);
                this.$store.dispatch('actionCartListData');
            }
        }*/
    }
        ...
        return _c(
          ...
          [
            ...
            _c("div", { staticClass: "add-cart-row" }, [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "item-entity" }, [
                _c("h5", [_vm._v(_vm._s(item.weight) + " lb")])
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "add-cart-row" }, [
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "add-cart-row" }, [
      _c("div", { staticClass: "item-type" }, [_c("h5", [_vm._v("Item")])])
    ])
  },
  function() {
    var _vm = this
      ...
      _c("div", { staticClass: "cart-column ship-details" }, [
        _c("table", [
          _c("tr", [
            ...
            _vm._v(" "),
            _c("td", [_vm._v("$" + _vm._s(_vm.cartTotal.toFixed(2)))])
          ]),
          _vm._v(" "),
          _c("tr", [
            _c("td", [_vm._v("US Taxes :")]),
            _vm._v(" "),
            _c("td", [_vm._v("$" + _vm._s(_vm.usTaxAmount.toFixed(2)))])
          ]),
          _vm._v(" "),
          _c("tr", [
            ...
            _vm._v(" "),
            _c("td", [
              _vm._v("$" + _vm._s(_vm.internationalShippingCost.toFixed(2)))
            ])
          ]),
          _vm._v(" "),
          _vm._m(1),
          ...
          _c("tr", [
            ...
            _vm._v(" "),
            _c("td", [_vm._v("$" + _vm._s(_vm.totalInsurance.toFixed(2)))])
          ]),
          _vm._v(" "),
              ...
              [
                [
                  _c(
                    "strong",
                    {
                      class: { "tooltip-toggle": _vm.grandTotal <= 0 },
                      attrs: { "data-tooltip": "One item has no weight" }
                    },
                    [
                      _vm._v(
                        "\n                                $" +
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "cart-column" }, [
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_api__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_axios_service__ = __webpack_require__(199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_cart_CartUserInfo__ = __webpack_require__(1243);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_cart_CardForm__ = __webpack_require__(1248);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        isCardActive: function isCardActive() {
            return this.$store.getters.isCardActive;
        },
        payments: function payments() {
            return this.$store.getters.getterPayments;
        }
        ...
        paymentMethodFormSubmit: function paymentMethodFormSubmit() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].postData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].placeOrder, this.payments).then(function (response) {
                if (response.data.status === true) {
                    _this.$store.dispatch('cartListData', {});
                }
            });
        },
        ...
        _c(
          ...
          [
            _c("input", {
              ...
              class: {
                input: true,
                "has-error": _vm.errors.has("expire_date")
              },
              attrs: {
                type: "month",
                name: "expire_date",
                          ...
                          [
                            ...
                            _vm.payments.paymentMethod === 2
                              ? _c("div", [
                                  _c("b", [
                                    _vm._v(
                                      "Please deposit the cash amount in this account no #0123"
                                    )
                                  ])
                                ])
                              : _vm._e()
