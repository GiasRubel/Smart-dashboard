...
var update = __webpack_require__(7)("543c0386", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vee_validate__ = __webpack_require__(201);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_api__ = __webpack_require__(180);
                ...
                if (valid) {
                    __WEBPACK_IMPORTED_MODULE_1__services_axios_service__["a" /* default */].postData(__WEBPACK_IMPORTED_MODULE_3__config_api__["a" /* default */].changePassword, _this.changePassword).then(function (response) {
                        if (response.data.message) {
                            _this.$router.push('/user/' + _this.$route.params.userId + '/change-password8');
