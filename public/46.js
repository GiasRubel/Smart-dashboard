...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(7)("dea4801a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_api__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config_config__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vee_validate__ = __webpack_require__(201);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_axios_service__ = __webpack_require__(199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_login_LoginFooter__ = __webpack_require__(1137);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        __WEBPACK_IMPORTED_MODULE_3_vee_validate__["a" /* Validator */].extend('emailOrPhone', {
            getMessage: function getMessage(field) {
                return 'The ' + field + ' must be either a valid e-mail or  phone number';
            },
            validate: function validate(value) {
                return __WEBPACK_IMPORTED_MODULE_2__config_config__["a" /* default */].EMAILREGEXP.test(value) || __WEBPACK_IMPORTED_MODULE_2__config_config__["a" /* default */].BDMOBILEREGEXP.test(value);
            }
        });
    },
            ...
            this.$validator.validateAll().then(function (valid) {
                if (valid) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_4__services_axios_service__["a" /* default */].postData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].forgotPassword, forgotPassword).then(function (response) {
                        ...
                        _this.$awn.success(_this.forgotPasswordError);
                    });
                }
            });
        }
                      ...
                      [
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _vm._l(_vm.forgotPasswordError.email, function(
                              error
                            ) {
                              return _vm.forgotPasswordError.email
                                ? _c("span", [
                                    _vm._v(
                                      "\n                                        " +
                                        _vm._s(error) +
