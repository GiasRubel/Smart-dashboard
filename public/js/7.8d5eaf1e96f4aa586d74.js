...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_Pagination__ = __webpack_require__(1241);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_InfoNotification__ = __webpack_require__(1216);
                  ...
                  ? _c("pagination", {
                      ...
                      on: {
                        paginate: function($event) {
                          _vm.getAllOrderedItemsWithPagination(_vm.selectedDay)
                        }
                      }
                    })
                  : _vm._e()
              ...
              [
                ...
                _vm._l(_vm.orderedItems, function(item) {
                  return _c("div", { staticClass: "order-list-row" }, [
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "order-list-column status-btn" }, [
                      item.status.alias === "cancel"
                        ? _c("h5", { staticClass: "label label-danger" }, [
                            _vm._v(
                              "\n                        " +
