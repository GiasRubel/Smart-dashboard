...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_dashboard_dashboard_UserOrderPaymentMethod__ = __webpack_require__(1485);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_dashboard_dashboard_UserMoneyRecite__ = __webpack_require__(1500);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_InfoNotification__ = __webpack_require__(1277);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__common_ContentLoader_vue__ = __webpack_require__(1531);
        ...
        cancelUrl: function cancelUrl(url) {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].postData(url).then(function (response) {
                if (response.data.status) {
                    ...
                    _this.$store.dispatch('actionOrderList', { day: 7, pagination: 1 });
                }
            });
        },
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_cart_CardForm__ = __webpack_require__(1287);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_user_dashboard_dashboard_ReviewCompleteOrder__ = __webpack_require__(1489);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_user_dashboard_dashboard_PartialPaymentPendingOrder__ = __webpack_require__(1494);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        modalHidePlease: function modalHidePlease() {
            this.$emit('close');
        }
    }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        paymentGateway: function paymentGateway() {
            ...
            if (gatewayId === 2) {
                return this.orderSubTaxInsTotal * this.$store.getters[__WEBPACK_IMPORTED_MODULE_2__store_types__["H" /* CONFIG_DEFAULT_SETTINGS */]].stripe + this.orderDetails.stripe_extra_charge;
            }
            if (gatewayId === 3) {
...
// module
exports.push([module.i, "\n.modal-mask[data-v-44ceb18e] {\n    position: fixed;\n    z-index: 9998;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    background-color: rgba(0, 0, 0, .5);\n    display: table;\n    -webkit-transition: opacity .3s ease;\n    transition: opacity .3s ease;\n}\n.modal-wrapper[data-v-44ceb18e] {\n    display: table-cell;\n    vertical-align: middle;\n}\n.modal-container[data-v-44ceb18e] {\n    width: 300px;\n    margin: 0px auto;\n    padding: 20px 30px;\n    background-color: #fff;\n    border-radius: 2px;\n    -webkit-box-shadow: 0 2px 8px rgba(0, 0, 0, .33);\n            box-shadow: 0 2px 8px rgba(0, 0, 0, .33);\n    -webkit-transition: all .3s ease;\n    transition: all .3s ease;\n    font-family: Helvetica, Arial, sans-serif;\n}\n.modal-header h3[data-v-44ceb18e] {\n    margin-top: 0;\n    color: #42b983;\n}\n.modal-body[data-v-44ceb18e] {\n    margin: 20px 0;\n}\n.modal-default-button[data-v-44ceb18e] {\n    float: right;\n}\n\n/*\n * The following styles are auto-applied to elements with\n * transition=\"modal\" when their visibility is toggled\n * by Vue.js.\n *\n * You can easily play with the modal transition by editing\n * these styles.\n */\n.modal-enter[data-v-44ceb18e] {\n    opacity: 0;\n}\n.modal-leave-active[data-v-44ceb18e] {\n    opacity: 0;\n}\n.modal-enter .modal-container[data-v-44ceb18e],\n.modal-leave-active .modal-container[data-v-44ceb18e] {\n    -webkit-transform: scale(1.1);\n    transform: scale(1.1);\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        paymentGateway: function paymentGateway() {
            ...
            if (gatewayId === 2) {
                return this.orderDetails.total_custom_amount * this.$store.getters[__WEBPACK_IMPORTED_MODULE_2__store_types__["H" /* CONFIG_DEFAULT_SETTINGS */]].stripe + this.orderDetails.stripe_extra_charge;
            }
            if (gatewayId === 3) {
    ...
    methods: {
        submitPartialPaymentPendingOrderPayment: function submitPartialPaymentPendingOrderPayment() {
            ...
            /*this.payments.order = {
             ...
             if (this.paymentGateway)
                this.payments.order.paymentGatewayCharge = this.paymentGateway.toFixed(2);
             this.$validator.validateAll().then((valid) => {
                if (valid && !this.partialPaymentPendingLoading) {
                    this.partialPaymentPendingLoading = true;
                    axiosService.postData(api.orderCustomAmount, this.payments).then(response => {
                        if (response.data) {
                            this.partialPaymentPendingLoading = false;
        ...
        _c("div", { staticClass: "order-details-status" }, [
          ...
          (_vm.orderDetails.status &&
            ...
            ? _c(
                ...
                [
                  _c("div", { staticClass: "send-payment" }, [
                    ...
                    _c(
                      ...
                      [_vm._v("Pay Now" + _vm._s(_vm.showModal))]
                    )
                  ]),
                  _vm._v(" "),
                  _vm.showModal
