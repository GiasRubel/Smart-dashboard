...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_ContentLoader_vue__ = __webpack_require__(1264);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_ContentLoader_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__common_ContentLoader_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        contentLoader: __WEBPACK_IMPORTED_MODULE_0__common_ContentLoader_vue___default.a
    },
    data: function data() {
        return {};
    },
    ...
    ? _c("div", { staticClass: "order-details" }, [
        _c("div", { staticClass: "order-header" }, [
          _c("div", { staticClass: "order-num" }, [
            _vm.orderDetails.purchase_invoice_number
              ? _c("h4", [
                  _vm._v(
                    "Invoice #" +
                      _vm._s(_vm.orderDetails.purchase_invoice_number)
                  )
                ])
              : _vm._e(),
            _vm._v(" "),
                  ...
                  _c("td", { staticClass: "mobile-hide" }, [
                    _vm._v(
                      "\n                    " +
                        _vm._s(_vm.currency) +
                        " " +
                        _vm._s(item.prices.insurance_amount.toFixed(2)) +
                        "\n                "
                    )
                  ]),
                  _vm._v(" "),
                  _c("td", { staticClass: "mobile-hide" }, [
                    _vm._v(
                      "\n                    " +
                        _vm._s(_vm.currency) +
                        " " +
                        _vm._s(item.prices.gift_amount.toFixed(2)) +
                        "\n                "
                    )
                  ]),
                  _vm._v(" "),
                      ...
                      "\n                    " +
                        ...
                        _vm._s(
                          (
                            ...
                            item.prices.item_subtotal_price
                          ).toFixed(2)
                        ) +
                        "\n                "
                    )
                    ...
                    _vm.payments.paymentMethod === 2
                      ? _c("td", { attrs: { colspan: "2" } }, [
                          _vm._v(
                            _vm._s(_vm.currency) +
                              " " +
                              _vm._s(_vm.orderDetails.master_price.toFixed())
                          )
                        ])
                      : _c("td", { attrs: { colspan: "2" } }, [
                          _vm._v(
                            _vm._s(_vm.currency) +
                              " " +
                              _vm._s(_vm.orderDetails.master_price.toFixed(2))
                          )
                        ])
                  ])
                : _vm._e()
