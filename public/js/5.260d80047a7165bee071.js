...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__UserPaymentCardForm__ = __webpack_require__(1402);
    ...
    computed: {
        ...
        cardList: function cardList() {
            ...
            _.forEach(card, function (value) {
                var data = value.expire_date.split('-');
                if (data[1] < 10) {
                    data = data[0] + '-0' + data[1];
                } else {
                    data = value.expire_date;
                }
                value.expire_date = __WEBPACK_IMPORTED_MODULE_2_moment___default()(data).format("MMMM YYYY");
            });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_common_TooltipBox__ = __webpack_require__(1220);
