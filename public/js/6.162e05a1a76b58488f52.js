...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_Pagination__ = __webpack_require__(1235);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_InfoNotification__ = __webpack_require__(1210);
    ...
    methods: {
        getAllOrderedItems: function getAllOrderedItems() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].getData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].allOrderItems + day + '&page=' + this.pagination.current_page).then(function (response) {
                ...
                _.forEach(_this.orderedItems, function (value, key) {
                    var createdTime = __WEBPACK_IMPORTED_MODULE_4_moment___default.a.utc(_this.orderedItems[key].order_date.date).local().format('YYYY-MM-DD HH:mm:ss');
                    _this.orderedItems[key].order_date.date = __WEBPACK_IMPORTED_MODULE_4_moment___default()(createdTime).startOf('hour').fromNow();
                });
