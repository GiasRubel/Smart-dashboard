...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_api__ = __webpack_require__(39);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
                ...
                if (valid) {
                    __WEBPACK_IMPORTED_MODULE_1__services_axios_service__["a" /* default */].postData(__WEBPACK_IMPORTED_MODULE_3__config_api__["a" /* default */].changePassword, _this.changePassword).then(function (response) {
                        if (response.data.message) {
                            _this.$router.push('/user/' + _this.$route.params.userId + '/change-password');
        ...
        cancelChangePasswordForm: function cancelChangePasswordForm() {
            this.$router.push('/user/' + this.$route.params.userId + '/change-password');
            this.changePassword = {};
        }
    }
});
