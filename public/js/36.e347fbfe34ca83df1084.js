...
var update = __webpack_require__(7)("5bad9eb7", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getUserDetails: function getUserDetails() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__services_axios_service__["a" /* default */].getData(__WEBPACK_IMPORTED_MODULE_0__config_api__["a" /* default */].userProfile).then(function (response) {
                _this.userData = response.data;
                _this.userData.mobile = _this.userData.defaultAddress && _this.userData.defaultAddress.phone ? _this.userData.defaultAddress.phone : _this.userData.mobile;
        ...
        submitUserForm: function submitUserForm() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__services_axios_service__["a" /* default */].patchData(__WEBPACK_IMPORTED_MODULE_0__config_api__["a" /* default */].userProfileAddUpdate, this.userData).then(function (response) {
                if (response.data) {
                    _this2.$awn.success(response.data.message);
                    _this2.$store.dispatch('actionOpenUserForm', false);
                }
            }).catch(function (error) {
                _this2.userError = error.response.data.errors;
            });
        },
            ...
            _c(
              ...
              [
                ...
                _c(
                  ...
                  [_vm._v("Change Your Password Here")]
                )
              ],
              1
            )
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "user-profile-image" }, [
