...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("1da0dff8", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("c70664de", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_cart_CardForm__ = __webpack_require__(1196);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        changeGateway: function changeGateway(gatewayID) {
            ...
            if (this.order) {
                this.$store.dispatch('actionCurrencyConvertOrder', currency);
            } else {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("2a1a497a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_login_LoginForm__ = __webpack_require__(1197);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_login_LoginSocialLink__ = __webpack_require__(1177);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_cart_CartProductList__ = __webpack_require__(1305);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_cart_CartProductTotalCount__ = __webpack_require__(1310);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_cart_CartPaymentMethod__ = __webpack_require__(1315);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_common_InfoNotification__ = __webpack_require__(1186);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("075f9dac", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_axios_service__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_api__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_TooltipBox__ = __webpack_require__(1191);
              ...
              [
                _vm._v(
                  _vm._s(_vm.currencyName) +
                    ...
                    _vm._s(
                      parseFloat(
                        item.prices.quantity * item.prices.item_price
                      ).toFixed(2)
                    ) +
                    "\n                "
                ),
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("c9ce961c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("73ec43d4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_cart_CartUserInfo__ = __webpack_require__(1319);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_common_CommonPaymentMethod__ = __webpack_require__(1202);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("74440def", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
