        ...
        emailVerify: function emailVerify() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].getData(this.resend + '?redirect=' + __WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].baseUrl + 'user/email/verify').then(function (response) {
                ...
                if (response.data.is_email_verify) {
                    ...
                    if (_this2.$store.getters[__WEBPACK_IMPORTED_MODULE_4__store_types__["D" /* CART_TOTAL_ITEM_QUANTITY */]] > 0) {
                        _this2.$store.dispatch(__WEBPACK_IMPORTED_MODULE_4__store_types__["h" /* CART_ITEM_APPEND_WITH_AUTHENTICATE */]);
                    } else {
                        _this2.$store.dispatch(__WEBPACK_IMPORTED_MODULE_4__store_types__["m" /* CART_ITEM_LIST */]);
                    }
                }
                if (response.data.resend) {
        ...
        checkUserIsAuthentic: function checkUserIsAuthentic() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].postBeforeVerified(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].emailVerified).then(function (response) {
                ...
                if (response.data.result && response.data.result.is_email_verify) {
                    ...
                    if (_this3.$store.getters[__WEBPACK_IMPORTED_MODULE_4__store_types__["D" /* CART_TOTAL_ITEM_QUANTITY */]] > 0) {
                        _this3.$store.dispatch(__WEBPACK_IMPORTED_MODULE_4__store_types__["h" /* CART_ITEM_APPEND_WITH_AUTHENTICATE */]);
                    } else {
                        _this3.$store.dispatch(__WEBPACK_IMPORTED_MODULE_4__store_types__["m" /* CART_ITEM_LIST */]);
                    }
