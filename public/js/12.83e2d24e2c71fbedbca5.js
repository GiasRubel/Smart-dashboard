...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_config__ = __webpack_require__(274);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_api__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_index__ = __webpack_require__(188);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_login_LoginFooter__ = __webpack_require__(1274);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config_config__ = __webpack_require__(274);
    ...
    methods: {
        verifyBrowser: function verifyBrowser() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].getData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].browserVerifyByToken + this.$route.query.token + '/' + this.$route.query.user + '/' + this.$route.query.browser).then(function (response) {
                ...
                if (response.data.is_browser_verify) _this.processResponse(response.data);

                if (response.data.resend) _this.resend = response.data.resend;else __WEBPACK_IMPORTED_MODULE_2__store_index__["a" /* default */].state.login.authenticated.is_email_verify = response.data.is_email_verify;
        ...
        browserVerify: function browserVerify() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].getData(this.resend + '?redirect=' + __WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].baseUrl + 'user/browser/verify').then(function (response) {
                ...
                if (response.data.is_browser_verify) _this2.processResponse(response.data);

                if (response.data.resend) _this2.resend = response.data.resend;else _this2.resend = '';
        ...
        againResend: function againResend() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].getData(this.resend + '?redirect=' + __WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].baseUrl + 'user/browser/verify').then(function (response) {
                ...
                if (response.data.resend) _this3.resend = response.data.resend;else _this3.resend = '';
            }).catch(function (error) {});
        },
        checkUserIsAuthentic: function checkUserIsAuthentic() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].postBeforeVerified(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].browserVerifiedCheck + __WEBPACK_IMPORTED_MODULE_4__config_config__["a" /* default */].browserId).then(function (response) {
                ...
                if (response.data.result && response.data.result.is_browser_verify) _this4.processResponse(response.data.result);
        ...
        processResponse: function processResponse(data) {
            ...
            if (this.$store.getters[__WEBPACK_IMPORTED_MODULE_5__store_types__["D" /* CART_TOTAL_ITEM_QUANTITY */]] > 0) this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_5__store_types__["h" /* CART_ITEM_APPEND_WITH_AUTHENTICATE */]);else this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_5__store_types__["m" /* CART_ITEM_LIST */]);

            this.$router.push(__WEBPACK_IMPORTED_MODULE_2__store_index__["a" /* default */].state.login.authenticated.redirect);
        }
    },
    computed: {
        authenticated: function authenticated() {
            return this.$store.getters.getterAuthenticated;
        }
    }
});
