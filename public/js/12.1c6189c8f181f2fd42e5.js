...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_config__ = __webpack_require__(266);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__LoginSocialLink__ = __webpack_require__(1222);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_api__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_index__ = __webpack_require__(185);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_login_LoginFooter__ = __webpack_require__(1228);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config_config__ = __webpack_require__(266);
        ...
        verifyBrowser: function verifyBrowser() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].getData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].browserVerifyByToken + this.$route.query.token + '/' + this.$route.query.user + '/' + this.$route.query.browser).then(function (response) {
                ...
                if (response.data.is_browser_verify) {
                    ...
                    if (_this.$store.getters[__WEBPACK_IMPORTED_MODULE_5__store_types__["D" /* CART_TOTAL_ITEM_QUANTITY */]] > 0) {
                        _this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_5__store_types__["h" /* CART_ITEM_APPEND_WITH_AUTHENTICATE */]);
                    } else {
                        _this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_5__store_types__["m" /* CART_ITEM_LIST */]);
                    }
                }
        ...
        browserVerify: function browserVerify() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].getData(this.resend + '?redirect=' + __WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].baseUrl + 'user/browser/verify').then(function (response) {
                ...
                if (response.data.is_browser_verify) {
                    ...
                    if (_this2.$store.getters[__WEBPACK_IMPORTED_MODULE_5__store_types__["D" /* CART_TOTAL_ITEM_QUANTITY */]] > 0) {
                        _this2.$store.dispatch(__WEBPACK_IMPORTED_MODULE_5__store_types__["h" /* CART_ITEM_APPEND_WITH_AUTHENTICATE */]);
                    } else {
                        _this2.$store.dispatch(__WEBPACK_IMPORTED_MODULE_5__store_types__["m" /* CART_ITEM_LIST */]);
                    }
                }
                if (response.data.resend) {
        ...
        checkUserIsAuthentic: function checkUserIsAuthentic() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].postBeforeVerified(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].browserVerifiedCheck + __WEBPACK_IMPORTED_MODULE_4__config_config__["a" /* default */].browserId).then(function (response) {
                ...
                if (response.data.result && response.data.result.is_browser_verify) {
                    ...
                    if (_this4.$store.getters[__WEBPACK_IMPORTED_MODULE_5__store_types__["D" /* CART_TOTAL_ITEM_QUANTITY */]] > 0) {
                        _this4.$store.dispatch(__WEBPACK_IMPORTED_MODULE_5__store_types__["h" /* CART_ITEM_APPEND_WITH_AUTHENTICATE */]);
                    } else {
                        _this4.$store.dispatch(__WEBPACK_IMPORTED_MODULE_5__store_types__["m" /* CART_ITEM_LIST */]);
                    }
