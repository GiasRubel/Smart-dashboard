...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_dashboard_dashboard_UserOrderPaymentMethod__ = __webpack_require__(1431);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_dashboard_dashboard_UserMoneyRecite__ = __webpack_require__(1446);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_InfoNotification__ = __webpack_require__(1223);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config_api__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_common_content_loader_js__ = __webpack_require__(1215);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_cart_CardForm__ = __webpack_require__(1233);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_user_dashboard_dashboard_ReviewCompleteOrder__ = __webpack_require__(1435);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_user_dashboard_dashboard_PartialPaymentPendingOrder__ = __webpack_require__(1440);
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_api__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_axios_service__ = __webpack_require__(34);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        paymentGateway: function paymentGateway() {
            ...
            if (gatewayId === 1) {
                return this.orderSubTaxInsTotal * this.$store.getters[__WEBPACK_IMPORTED_MODULE_2__store_types__["G" /* CONFIG_DEFAULT_SETTINGS */]].sslCommerz;
            }
            if (gatewayId === 2) {
                return this.orderSubTaxInsTotal * this.$store.getters[__WEBPACK_IMPORTED_MODULE_2__store_types__["G" /* CONFIG_DEFAULT_SETTINGS */]].stripe + 0.3;
            }
            if (gatewayId === 3) {
                return this.orderSubTaxInsTotal * this.$store.getters[__WEBPACK_IMPORTED_MODULE_2__store_types__["G" /* CONFIG_DEFAULT_SETTINGS */]].americanExpress;
            }
        },
...
var normalizeComponent = __webpack_require__(1)
/* script */
var __vue_script__ = __webpack_require__(1443)
/* template */
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        paymentGateway: function paymentGateway() {
            ...
            if (gatewayId === 1) {
                return this.orderDetails.total_custom_amount * this.$store.getters[__WEBPACK_IMPORTED_MODULE_2__store_types__["G" /* CONFIG_DEFAULT_SETTINGS */]].sslCommerz;
            }
            if (gatewayId === 2) {
                return this.orderDetails.total_custom_amount * this.$store.getters[__WEBPACK_IMPORTED_MODULE_2__store_types__["G" /* CONFIG_DEFAULT_SETTINGS */]].stripe + 0.3;
            }
            if (gatewayId === 3) {
                return this.orderDetails.total_custom_amount * this.$store.getters[__WEBPACK_IMPORTED_MODULE_2__store_types__["G" /* CONFIG_DEFAULT_SETTINGS */]].americanExpress;
            }
        },
        orderGrandTotal: function orderGrandTotal() {
            if (this.paymentGateway) {
