...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__UserNotifications__ = __webpack_require__(1390);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            markedData: '',
            notificationTypeList: [{ name: 'Read', sortType: 'read=1' }, { name: 'Unread', sortType: 'unread=1' }, { name: 'Ascending', sortType: 'order=aesc' }, { name: 'Descending', sortType: 'order=desc' }],
    ...
    methods: {
        getAllNotifications: function getAllNotifications() {
            this.$store.dispatch('actionAllNotifications', { type: 'order=aesc', name: 'all', current_page: 1 });
...
var render = function() {
  ...
  return _c("div", { staticClass: "user-notification" }, [
    _c(
      "div",
          ...
          _c("div", [
            _c(
              ...
              _vm._l(_vm.notificationTypeList, function(type) {
                return _c("option", { domProps: { value: type.sortType } }, [
          ...
          _c("div", [
            _c(
              "a",
              {
                ...
                attrs: {
                  "data-tooltip": _vm.isRead ? "Mark as read" : "Mark as unread"
                },
                on: { click: _vm.getMarkedItems }
              },
              [
                _c("i", {
                  class: _vm.isRead ? "fas fa-envelope-open" : "fas fa-envelope"
                })
              ]
            )
          ])
