...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        processResponse: function processResponse(data) {
            ...
            if (this.$store.getters[__WEBPACK_IMPORTED_MODULE_4__store_types__["E" /* CART_TOTAL_ITEM_QUANTITY */]] > 0) this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_4__store_types__["h" /* CART_ITEM_APPEND_WITH_AUTHENTICATE */]);else this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_4__store_types__["m" /* CART_ITEM_LIST */]);
