...
var update = __webpack_require__(5)("543c0386", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_api__ = __webpack_require__(21);
    ...
    methods: {
        changePasswordForm: function changePasswordForm() {
            ...
            this.$validator.validateAll().then(function (valid) {
                if (valid && !_this.changePasswordLoading) {
        ...
        "form",
        {
          on: {
            submit: function($event) {
              ...
              return _vm.changePasswordForm($event)
            }
          }
        },
        [
                  ...
                  directives: [
                    ...
                    },
                    {
                      ...
                      value: {
                        ...
                        passwordAlphaDigitMinMax: _vm.passwordAlphaDigitMinMax,
                        is_not: _vm.changePassword.current_password
                      },
                      expression:
                        "{required, passwordAlphaDigitMinMax, is_not: changePassword.current_password }"
                    }
                  ],
                  ref: "password",
                  staticClass: "form-control",
                        ...
                        directives: [
                          {
                            ...
                            value:
                              ...
                              !_vm.errors.has("new_password:is_not"),
                            expression:
                              "errors.has('new_password') && !errors.has('new_password:is_not')"
                          }
                        ]
                      },
                      [
                        ...
                        directives: [
                          {
                            name: "show",
                            rawName: "v-show",
                            value: _vm.errors.has("new_password:is_not"),
                            expression: "errors.has('new_password:is_not')"
                          }
                        ]
                      },
                      [
