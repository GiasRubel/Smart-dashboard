...
var update = __webpack_require__(6)("09b29dbb", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__UserNotifications__ = __webpack_require__(1345);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("0f24654e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
