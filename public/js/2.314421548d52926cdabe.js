...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_InfoNotification__ = __webpack_require__(1219);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_common_content_loader_js__ = __webpack_require__(1464);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_cart_CardForm__ = __webpack_require__(1229);
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_api__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_axios_service__ = __webpack_require__(33);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        paymentGateway: function paymentGateway() {
            ...
            if (gatewayId === 1) {
                return this.orderDetails.total_custom_amount * this.$store.getters.getterDefaultValues.sslCommerz;
            }
            if (gatewayId === 2) {
                return this.orderDetails.total_custom_amount * this.$store.getters.getterDefaultValues.stripe + 0.3;
            }
            if (gatewayId === 3) {
                return this.orderDetails.total_custom_amount * this.$store.getters.getterDefaultValues.americanExpress;
            }
        },
        orderGrandTotal: function orderGrandTotal() {
            if (this.paymentGateway) {
