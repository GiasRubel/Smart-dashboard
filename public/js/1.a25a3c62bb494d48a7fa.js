...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_3_vuex__["b" /* mapGetters */])({
        countries: __WEBPACK_IMPORTED_MODULE_2__store_types__["N" /* LOC_COUNTRY_LIST */],
        states: __WEBPACK_IMPORTED_MODULE_2__store_types__["R" /* LOC_STATE_LIST */]
    })),
    methods: {
        submitAddressForm: function submitAddressForm() {
            ...
            var formSubmitCallback = function formSubmitCallback(response) {
                if (response.data.message && response.data.result) {
                    ...
                    _this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_2__store_types__["V" /* LOC_USER_ADDRESS_ADD_UPDATE */], response.data.result);
                    if (response.data.result && response.data.result.is_default) {
                        _this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_2__store_types__["Z" /* LOC_USER_ADDRESS_SET_DEFAULT */], response.data.result.id);
                    }
            ...
            this.$validator.validateAll().then(function (valid) {
                if (valid && !_this.addressLoading) {
                    ...
                    if (_this.$route.params.addressId) {
                        ...
                        if (!Object.keys(_this.$store.getters[__WEBPACK_IMPORTED_MODULE_2__store_types__["X" /* LOC_USER_ADDRESS_LIST */]]).length) {
        ...
        getCountries: function getCountries() {
            this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_2__store_types__["O" /* LOC_COUNTRY_LIST_API */]);
        },
        getStates: function getStates(countryID) {
            this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_2__store_types__["S" /* LOC_STATE_LIST_API */], countryID);
        },
      ...
      [
        ...
        _c(
          ...
          [
            ...
            _c(
              "button",
              { attrs: { type: "submit", id: "test-submit-address" } },
              [
