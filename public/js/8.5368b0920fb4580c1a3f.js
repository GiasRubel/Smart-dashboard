...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__UserPaymentCardForm__ = __webpack_require__(1352);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vee_validate__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__config_config__ = __webpack_require__(265);
//
//
//
//
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.moment = __WEBPACK_IMPORTED_MODULE_2_moment___default.a;
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        __WEBPACK_IMPORTED_MODULE_4_vee_validate__["a" /* Validator */].extend('cvc', {
            getMessage: function getMessage(field) {
                return 'Insert last 3 or 4 digit of your card or 3 digit code from the back part of\n            your card';
            },
            validate: function validate(value) {
                return __WEBPACK_IMPORTED_MODULE_5__config_config__["a" /* default */].CVC.test(value);
            }
        });
    ...
    methods: {
            ...
            this.$validator.validateAll().then(function (valid) {
                if (valid) {
                    ...
                    if (_.isEmpty(_this.cardDetailsData)) {
                        ...
                        __WEBPACK_IMPORTED_MODULE_3__services_axios_service__["a" /* default */].postData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].card + 'store', _this.cardPayment).then(formSubmitCallback).catch(formErrorCallback);
                    } else {
                        _this.$store.dispatch('cardPaymentForm', _this.cardPayment);
                        __WEBPACK_IMPORTED_MODULE_3__services_axios_service__["a" /* default */].patchData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].card + 'update/' + _this.cardDetailsData.id, _this.cardPayment).then(formSubmitCallback).catch(formErrorCallback);
                    }
                }
            });
        },
        ...
        getCardDetails: function getCardDetails(cardDetailLink) {
            ...
            __WEBPACK_IMPORTED_MODULE_3__services_axios_service__["a" /* default */].getData(cardDetailLink).then(function (response) {
                ...
                _this2.cardPayment.expire_date = __WEBPACK_IMPORTED_MODULE_2_moment___default()(_this2.cardPayment.expire_date).format("YYYY-MM");
        ...
        getGatewayList: function getGatewayList() {
            ...
            __WEBPACK_IMPORTED_MODULE_3__services_axios_service__["a" /* default */].getData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].localHostUrl + 'api/payment/method/1').then(function (response) {
