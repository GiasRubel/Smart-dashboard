...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        submitAddressForm: function submitAddressForm() {
            ...
            /*let phones = this.address.phones;
            this.address.phones = [];
            phones.forEach((value, key) => {
                if (value.phone) {
                    this.address.phones[key] = {
                        phone: value.phone
                }
                }
            });*/
            ...
            var formSubmitCallback = function formSubmitCallback(response) {
                if (response.data.message && response.data.result) {
                    ...
                    if (response.data.result && response.data.result.is_default) {
                        ...
                        // this.$store.dispatch('actionUpdateUserProfileDefaultAddress', response.data.result);
                    }
