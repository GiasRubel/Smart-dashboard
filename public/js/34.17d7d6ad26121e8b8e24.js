          ...
          _vm._l(_vm.orderDetails.items, function(item, key) {
            return _c("tr", { attrs: { index: key } }, [
              ...
              _c("td", { staticClass: "mobile-hide" }, [
                _vm._v(_vm._s(item.prices.quantity))
              ]),
              _vm._v(" "),
              _c("td", { staticClass: "mobile-hide" }, [
                _vm._v(_vm._s(item.prices.insurance_amount))
              ]),
              _vm._v(" "),
              _c("td", { staticClass: "mobile-hide" }, [
                _vm._v(_vm._s(item.prices.gift_amount))
              ]),
              _vm._v(" "),
              _c("td", { staticClass: "mobile-hide" }, [
                _vm._v(
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("tr", [
      ...
      _vm._v(" "),
      _c("th", { staticClass: "mobile-hide" }, [_vm._v("Custom Amount")]),
      _vm._v(" "),
      _c("th", [_vm._v("Amount")])
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("tr", [_c("td", { attrs: { colspan: "11" } })])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
