...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_social_signup_service__ = __webpack_require__(1213);
...
var normalizeComponent = __webpack_require__(1)
/* script */
var __vue_script__ = __webpack_require__(1237)
/* template */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config_api__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_config__ = __webpack_require__(360);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__store_types__ = __webpack_require__(1464);
//
//
//
//
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_axios_service__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_cart_CardForm__ = __webpack_require__(1233);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__store_types__ = __webpack_require__(1464);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        changeGateway: function changeGateway(gatewayID) {
            ...
            this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_5__store_types__["T" /* SET_BASE_CURRENCY */], currency);
        }
    }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_config__ = __webpack_require__(360);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_axios_service__ = __webpack_require__(34);
//
//
//
//
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_login_LoginForm__ = __webpack_require__(1234);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_login_LoginSocialLink__ = __webpack_require__(1209);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_cart_CartProductList__ = __webpack_require__(1342);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_cart_CartProductTotalCount__ = __webpack_require__(1347);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_cart_CartPaymentMethod__ = __webpack_require__(1352);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_common_InfoNotification__ = __webpack_require__(1223);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__store_types__ = __webpack_require__(1464);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_common_content_loader_js__ = __webpack_require__(1215);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_axios_service__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_api__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_TooltipBox__ = __webpack_require__(1228);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vuex__ = __webpack_require__(367);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__store_types__ = __webpack_require__(1464);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_TooltipBox__ = __webpack_require__(1228);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__store_types__ = __webpack_require__(1464);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuex__ = __webpack_require__(367);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_cart_CartUserInfo__ = __webpack_require__(1356);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_common_CommonPaymentMethod__ = __webpack_require__(1239);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_types__ = __webpack_require__(1464);
//
//
//
//
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store_types__ = __webpack_require__(1464);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vuex__ = __webpack_require__(367);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
        ...
        paymentMethodFormSubmit: function paymentMethodFormSubmit() {
            ...
            this.$validator.validateAll().then(function (valid) {
                if (valid && !_this2.paymentLoading) {
                    ...
                    delete _this2.address.country;
                    delete _this2.address.state;

                    var phones = _this2.address.phones;
                    _this2.address.phones = [];
                    phones.forEach(function (value, key) {
                        if (value.phone) {
                            _this2.address.phones[key] = {
                                phone: value.phone
                            };
                        }
                    });
                    _this2.payments.address = _this2.address;
                    _this2.payments.order = _this2.order;

                    if (!Object.keys(_this2.$store.getters.getAddressList).length) {
                        _this2.address.is_default = true;
                        // this.$store.dispatch('actionUpdateUserProfileDefaultAddress', this.address);
                    }

                    _this2.$store.dispatch('addUpdateAddress', _this2.address);
                    _this2.$store.dispatch('setActiveCard', _this2.cardList);
        ...
        reviewOrder: function reviewOrder() {
            ...
            this.$validator.validateAll().then(function (valid) {
                if (valid && !_this3.paymentLoading) {
                    _this3.paymentLoading = true;

                    delete _this3.address.country;
                    delete _this3.address.state;

                    var phones = _this3.address.phones;
                    _this3.address.phones = [];
                    phones.forEach(function (value, key) {
                        if (value.phone) {
                            _this3.address.phones[key] = {
                                phone: value.phone
                            };
                        }
                    });
                    _this3.payments.address = _this3.address;
                    _this3.payments.order = _this3.order;

                    if (!Object.keys(_this3.$store.getters.getAddressList).length) {
                        _this3.address.is_default = true;
                    }

                    _this3.$store.dispatch('addUpdateAddress', _this3.address);
                    _this3.$store.dispatch('setActiveCard', _this3.cardList);
        ...
        getUserAddressList: function getUserAddressList() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].getData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].address).then(function (response) {
                if (response.data.result) {
                    _this4.$store.dispatch('addressList', response.data.result);
                }
            }).catch(function (error) {});
        },
