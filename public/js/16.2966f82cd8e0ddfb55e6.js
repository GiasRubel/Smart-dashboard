...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_ContentLoader_vue__ = __webpack_require__(1264);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        addressList: function addressList() {
            return this.$store.getters[__WEBPACK_IMPORTED_MODULE_3__store_types__["X" /* LOC_USER_ADDRESS_LIST */]];
        },
        defaultAddress: function defaultAddress() {
            return this.$store.getters[__WEBPACK_IMPORTED_MODULE_3__store_types__["_0" /* LOC_USER_DEFAULT_ADDRESS */]];
        },
    ...
    methods: {
        setDefaultAddress: function setDefaultAddress(addressId) {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].postData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].address + '/setDefault', { address_id: addressId }).then(function (response) {
                if (response.data.result) _this2.$store.dispatch(__WEBPACK_IMPORTED_MODULE_3__store_types__["Z" /* LOC_USER_ADDRESS_SET_DEFAULT */], response.data.result.id);
        ...
        deleteAddress: function deleteAddress(addressId) {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].postData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].address + '/delete', { id: addressId }).then(function (response) {
                if (response.data.message) _this3.$store.dispatch(__WEBPACK_IMPORTED_MODULE_3__store_types__["W" /* LOC_USER_ADDRESS_DELETE */], addressId);
