...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        addGift: function addGift(cartItem, index) {
            console.log(index, this.isGiftAvailable[cartItem.id]);
        ...
        removeItemFromCart: function removeItemFromCart(cartItem, index) {
            ...
            _.forEach(this.addressList, function (value) {
                if (value.is_default === true) {
                    _this4.country_id = value.country_id;
                    _this4.state_id = value.state_id;
                }
            });

            this.$store.dispatch('actionDeleteItem', { index: index, item: cartItem, stateId: this.state_id, countryId: this.country_id });
        },
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "btn-continue" }, [
      _c("button", [_vm._v("Continue Shopping")])
    ])
  }
]
render._withStripped = true
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        paymentGateway: function paymentGateway() {
            return this.$store.getters.getterPaymentGatewayCharge;
        },
        authenticated: function authenticated() {
            return this.$store.state.login.authenticated;
        },
        currencyName: function currencyName() {
            return this.$store.getters.getterCurrencyName === 'BDT' ? 'BDT' : '$';
        },
        orderForReview: function orderForReview() {
            return this.$store.getters.getterOrderForReview;
        },
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        paymentMethodFormSubmit: function paymentMethodFormSubmit() {
            ...
            this.$validator.validateAll().then(function (valid) {
                if (valid && !_this.paymentLoading) {
                    _this.paymentLoading = true;
                    delete _this.address.country;
                    delete _this.address.state;
                    ...
                    _this.payments.address = _this.address;
                    _this.payments.order = _this.order;
                    ...
                    _this.$store.dispatch('addUpdateAddress', _this.address);
                    _this.$store.dispatch('setActiveCard', _this.cardList);

                    __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].postData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].placeOrder, _this.payments).then(function (response) {
        ...
        reviewOrder: function reviewOrder() {
            ...
            this.$validator.validateAll().then(function (valid) {
                if (valid && !_this2.paymentLoading) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].postData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].reviewOrder, _this2.payments).then(function (response) {
                        if (response.data.original && response.data.original.status === true) {
