...
var update = __webpack_require__(7)("f04680c6", content, false, {});
  ...
  function() {
    ...
    return _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "footer-content" }, [
        ...
        _c("p", [
          _vm._v(
            "\n            ShopnShipBD is an online e-commerce site from where you can from world's largest shopping websites. Unlike\n            ever before, you will be able to surf world's largest shopping websites through ShopnShipBD's integrated\n            services and get immediately quoted for your orders with a total price that is all inclusive of transparent\n            customs and shipping charges. It's convenient, easy and delivered right to your doorstep. You also can\n            receive your product from ShopnShipBD’s regional office in Bangladesh. You shouldn't be limited to what you\n            can and cannot buy online except some prohibited items. We understand that the overwhelming majority of\n            users online today want to pay for their orders online, and we let you do just that with ShopnShipBD, Credit\n            card payments are also accepted on the ShopnShipBD website.ShopnShipBD's service is based on a secure\n            payment network that enables customers to complete their purchases conveniently around their city and it's\n            absolutely 100% guaranteed to be safe, or your money back! The world is your shopping cart, and it all\n            starts with ShopnShipBD!\n        "
          )
        ])
      ])
    ])
