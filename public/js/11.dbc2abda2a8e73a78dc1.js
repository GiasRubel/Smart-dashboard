...
var update = __webpack_require__(6)("0864fed9", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__UserPaymentCardForm__ = __webpack_require__(1372);
    ...
    computed: {
        ...
        cardList: function cardList() {
            ...
            _.forEach(card, function (value) {
                value.expire_date = Object(__WEBPACK_IMPORTED_MODULE_2_moment__["default"])(value.expire_date).format("MMMM YYYY");
            });
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("53b49b2c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_axios_service__ = __webpack_require__(41);
//
//
//
//
