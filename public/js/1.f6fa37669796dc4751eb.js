        ...
        submitAddressForm: function submitAddressForm() {
            ...
            var formSubmitCallback = function formSubmitCallback(response) {
                if (response.data.message && response.data.result) {
                    ...
                    _this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_2__store_types__["T" /* LOC_USER_ADDRESS_ADD_UPDATE */], response.data.result);
                    if (response.data.result && response.data.result.is_default) {
                        _this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_2__store_types__["X" /* LOC_USER_ADDRESS_SET_DEFAULT */], response.data.result.id);
                    }
            ...
            this.$validator.validateAll().then(function (valid) {
                if (valid && !_this.addressLoading) {
                    ...
                    if (_this.$route.params.addressId) {
                        ...
                        if (!Object.keys(_this.$store.getters[__WEBPACK_IMPORTED_MODULE_2__store_types__["V" /* LOC_USER_ADDRESS_LIST */]]).length) {
