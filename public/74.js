...
var update = __webpack_require__(7)("042fab5f", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getOrderDetails: function getOrderDetails() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_axios_service__["a" /* default */].getData(__WEBPACK_IMPORTED_MODULE_1__config_api__["a" /* default */].orderDetails + this.$route.params.orderId).then(function (response) {
    ...
    _c("div", { staticClass: "order-header" }, [
      _c("div", { staticClass: "order-num" }, [
        ...
        _vm.orderDetails.address
          ? _c("div", [
              ...
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(_vm.orderDetails.address.country.title))]),
              _vm._v(" "),
              _c("p", [
                _vm._v("Phone : " + _vm._s(_vm.orderDetails.address.phone))
              ])
            ])
          : _vm._e()
      ]),
      ...
      _c("div", { staticClass: "company-logo" }, [
        _c("div", { staticClass: "order-date" }, [
          ...
          _c("span", [_vm._v(_vm._s(_vm.orderDetails.order_date))])
        ]),
        _vm._v(" "),
        ...
        [
          ...
          _vm._l(_vm.orderDetails.items, function(item, key) {
            return _c("tr", { attrs: { index: key } }, [
              ...
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(item.store))]),
              _vm._v(" "),
              ...
              _vm._v(" "),
              _c("td", { staticClass: "mobile-hide" }, [
                _vm._v("$" + _vm._s(item.prices.item_price))
              ]),
              _vm._v(" "),
              _c("td", [
                _vm._v("$" + _vm._s(item.quantity * item.prices.item_price))
              ])
            ])
          }),
          _vm._v(" "),
          ...
          _c("tr", { staticClass: "row-bg" }, [
            _c("td", { staticClass: "mobile-hide", attrs: { colspan: "2" } }),
            _vm._v(" "),
            _c("td", { attrs: { colspan: "4" } }),
            _vm._v(" "),
            _c("td", [_vm._v("Sub Total")]),
            _vm._v(" "),
            _c("td", [_vm._v("$" + _vm._s(_vm.orderDetails.total_price))])
          ]),
          _vm._v(" "),
          _c("tr", { staticClass: "row-bg" }, [
            _c("td", { staticClass: "mobile-hide", attrs: { colspan: "2" } }),
          ...
          _c("tr", { staticClass: "row-bg" }, [
            ...
            _vm._v(" "),
            _c("td", [_vm._v("$" + _vm._s(_vm.orderDetails.shipment_cost))])
          ]),
          _vm._v(" "),
          _c("tr", { staticClass: "row-bg" }, [
            _c("td", { staticClass: "mobile-hide", attrs: { colspan: "2" } }),
            ...
            _vm._v(" "),
            _c("td", [_vm._v("$" + _vm._s(_vm.orderDetails.master_price))])
          ])
        ],
        2
      )
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "order-button" }, [
      _c("button", [
