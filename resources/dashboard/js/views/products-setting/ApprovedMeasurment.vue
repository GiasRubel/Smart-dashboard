                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            <router-link to="/dashboard/products/products-measurment/create" style="margin-top: 0px;" class="btn btn-primary" tag="button" type="button">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover table-expandable">
                            ...
                            <tr v-for="(measurment,key) in product_measurments">
                                ...
                                <td class="mobile-hide">
                                    <template v-if="measurment.volumetric_weight">{{measurment.volumetric_weight | toFix}}</template>
                                    <template v-else>None</template>
                                </td>
                                ...
                                <td>
                                    <router-link
                                            :to="{name: 'Edit Approved Measurment', params: {id: measurment.id}}"
    ...
    export default {
        ...
        methods: {
            ...
            productMeasurmentList(st = false) {
                ...
                axios.get('/dashboard/product-measurment-approved?page=' + this.pagination.current_page  + '&field=' + this.field + '&q=' + this.query + '&per_page=' + this.perlist)
                    .then(response => {
