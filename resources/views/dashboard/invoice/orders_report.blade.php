...
<div class="wraper" style="padding: 20px;">
    <table id="table">
        <tr>
            ...
            <th style="text-align: right">Grand price</th>
        ...
        @foreach($orders as $key => $order)
            <tr>
                ...
                <td style="width: 40%;">
                    ...
                    {{ optional($order->address)->address.", ".optional($order->address)->address_2 }}

                        {{ optional($order->address)->address_2 != '' ? ", ".optional($order->address)->address_2 : '' }}
                </td>
                <td  align="right">${{ number_format($order->master_price, 2, '.', '')  }}</td>
