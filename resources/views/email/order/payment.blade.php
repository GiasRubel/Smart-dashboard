                                                ...
                                                <td class="imgResponsive" align="center" valign="middle" style="padding:0;">
                                                    <singleline style="text-align: left;">
                                                        ...
                                                        <p>
                                                            ...
                                                            @else
                                                                Thank you for your shopping from ShopNShipBD. To confirm your order, please submit the cash receipt.
                                                ...
                                                <table style="margin: 30px 0; width: 100%;" border="1">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2" style="padding: 5px 10px; font-weight: 600;text-align: center; ">
                                                                {{ $currency }}{{ number_format(($order->total_price - $order->total_insurance) * explode('-', $charge["value_d"])[0], 2, '.', '') }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style="padding: 5px 10px; font-weight: 600; text-align: center;">Total US tax</td>
                                                            <td colspan="2" style="padding: 5px 10px; font-weight: 600;text-align: center; ">
                                                                {{ $currency }}{{ number_format($order->tax_usa * explode('-', $charge["value_d"])[0], 2, '.', '') }}
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2" style="padding: 5px 10px; font-weight: 600;text-align: center; ">
                                                                {{ $currency }}{{ number_format($order->total_insurance * explode('-', $charge["value_d"])[0], 2, '.', '') }}
                                                            </td>
                                                        </tr>
                                                        @endif
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2" style="padding: 5px 10px; font-weight: 600;text-align: center; ">
                                                                {{ $currency }}{{ number_format($order->total_gift * explode('-', $charge["value_d"])[0], 2, '.', '') }}
                                                            </td>
                                                        </tr>
                                                        @endif
                                                        <tr>
                                                            ...
                                                            <td colspan="2" style="padding: 5px 10px; font-weight: 600;text-align: center; ">
                                                                {{ $currency }}{{ number_format($order->shipping_cost * explode('-', $charge["value_d"])[0], 2, '.', '') }}
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2" style="padding: 5px 10px; font-weight: 600;text-align: center; ">
                                                                {{ $currency }}{{ number_format($order->service_charge * explode('-', $charge["value_d"])[0], 2, '.', '') }}
                                                            </td>
                                                        </tr>
                                                        <tr>
