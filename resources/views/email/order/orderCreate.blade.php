                                    ...
                                    <td class="containerPadding" align="center" valign="top">
                                            ...
                                            <tr>
                                                <td class="imgResponsive" align="center" valign="middle" style="padding:0;">
                                                    <singleline style="text-align: left;">
                                                        ...
                                                        <p>Thanks for your order. Your order will be delivered to you within our estimated delivery time.</p>
                                                    </singleline>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table style="margin: 30px 0; width: 100%;" border="1">
                                            ...
                                            <tr>
                                                ...
                                                <th style="padding: 5px 10px;text-align: center;">Item price</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            @foreach($order->items as $item)
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px 10px;text-align: center;">{{  optional($item->itemPrice)->item_current_price }}</td>
                                                </tr>
                                            @endforeach
                                            <tr>
                                        ...
                                        <table class="row" width="500" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="contDescription centerText" align="center" valign="middle"
                                                    ...
                                                    <singleline>
                                                        If you want to ship your product through us, please pay our shipping cost.
                                                    </singleline>
                                                </td>
                                            </tr>
                                            <tr>
